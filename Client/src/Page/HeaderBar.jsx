...
function Location({ location }) {
    ...
    return (<div style={{ zIndex: 50, backgroundColor: "white", position: "fixed", top: 0, marginRight: "60%", width: "40%", height: 40, borderBottomWidth: 2, borderBottomStyle: "solid" }}>
        {fil.map((e, i) => {
...
function User({ }) {
    return (<div style={{ zIndex: 50, backgroundColor: "white", position: "fixed", top: 0, width: "20%", marginLeft: "80%", height: 40, borderBottomWidth: 2, borderBottomStyle: "solid" }}>
        <p>User</p>
    </div>)
}
